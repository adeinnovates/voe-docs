...
description: Private iCal/ICS feeds — read-only, encrypted at rest, revocable at the source.
---
...
curl -s -X POST "$VOE/v1/calendar-feeds" \
  ...
  -d '{"url":"https://calendar.google.com/calendar/ical/…/private-…/basic.ics","label":"Work"}'
```
