...
The original bytes, workspace-scoped — this is what the evidence hash proves. Use it for preview and download in your UI.
...
:::warning
An attachment relevant to a question but not readable appears in the gap report by filename and state. Surface that — "the memory holds this file but cannot read it yet" is information your user needs.
:::
