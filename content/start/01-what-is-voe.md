...
- The record is plain files, replayable: reindexing from the files reproduces the same pages, edges, and chunks, and reports drift if it cannot.
...
- [What ships today](/start/what-ships-today) — the capability matrix, no roadmap blur.
