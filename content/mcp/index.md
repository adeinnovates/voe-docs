---
title: MCP
description: The same engine as tools — stdio and HTTP transports, strict grounding, client setup.
---

# MCP

One token, one principal, one workspace — the same engine as the API, exposed as tools.
