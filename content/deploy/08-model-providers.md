...
Capture of parseable material, search, context packing, the graph, grants, and review run with no model configured. A cell without a key is a working memory that cannot synthesize.
